using Interpolations, Plots, FastGaussQuadrature, Parameters, LinearAlgebra
using Distributions, Roots, SparseArrays, Measures, StatsBase, StatsPlots
...
@time k_prim, S, c, φ, V = HH_Ayiagari_two_assets_endo(M, N, MD, ε_hh, ε_κ, h)
...
@time mobility_results_50, quantiles = mobility_simulation(W_stat, c, φ, h; T = 50)
@time mobility_results_150, quantiles = mobility_simulation(W_stat, c, φ, h; T = 150)
plt = plot_mobility_results(mobility_results_50, mobility_results_150, custom_colors)
savefig(plt, "figures/figure_3.pdf")